...
def iou(bbox1, bbox2):
    ...
    Each bbox should be a list/tuple of 4 values: [x0, y0, x1, y1]
    """
    # Ensure bbox1 and bbox2 are lists/tuples of 4 values
    if not isinstance(bbox1, (list, tuple)) or not isinstance(bbox2, (list, tuple)) or len(bbox1) != 4 or len(bbox2) != 4:
        return 0
    ...
    try:
        ...
        union = rect1.include_rect(rect2)
