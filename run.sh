...
# magic-pdf -p inputs/export_pdf/pdf -o azure_outputs -m auto
# magic-pdf -p inputs/export_pdf/pdf -o outputs/mineru_outputs_layoutlmv3 -m auto

# date
# magic-pdf -p inputs/export_pdf/pdf -o azure_outputs_txt -m txt

# magic-pdf -p inputs/export_pdf/pdf -o mineru_outputs_ocr_ft_slanet_plus -m ocr
...
python scripts/convert_azure_tables_from_pkl.py \
    --pkl-file /home/xing/MinerU_Protago/inputs/export_pdf/azure_pkl/f_QGrLZ33G.pkl \
    --pdf-file /home/xing/MinerU_Protago/inputs/export_pdf/pdf/f_QGrLZ33G.pdf \
    --output /home/xing/MinerU_Protago/inputs/export_pdf/tables_from_pkl/

# # # batch extract tables from pkl
# python scripts/convert_azure_tables_from_pkl.py \
#     --input /home/xing/MinerU_Protago/inputs/export_pdf/azure_pkl \
#     --pdf-dir /home/xing/MinerU_Protago/inputs/export_pdf/pdf \
#     --output /home/xing/MinerU_Protago/inputs/export_pdf/tables_from_pkl


python scripts/prepare_orbit_dataset.py \
    --input_dir /home/xing/MinerU_Protago/inputs/export_pdf/tables_from_pkl \
    --output_dir /home/xing/MinerU_Protago/outputs/orbit_data \
    --combine
