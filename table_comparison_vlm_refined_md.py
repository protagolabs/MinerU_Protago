...
def process_folders(mineru_folder: str, 
    ...
    # Get all JSON files from Azure folder if matching_pairs not provided
    ...
    for azure_file in matching_pairs:
        ...
        mineru_path = os.path.join(mineru_folder, mineru_file)
        file_pairs.append((azure_path, mineru_path))
...
def main() -> None:
    try:
        ...
        results = process_folders(
            ...
            num_processes=8  # Optional: number of processes for file processing
        )
