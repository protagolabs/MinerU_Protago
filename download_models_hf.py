...
if __name__ == '__main__':
    ...
    model_dir = snapshot_download('opendatalab/PDF-Extract-Kit-1.0', local_dir='./local_models', allow_patterns=mineru_patterns)

    layoutreader_pattern = [
        "*.json",
        "*.safetensors",
    ]
    layoutreader_model_dir = snapshot_download('hantian/layoutreader', local_dir='./local_models/layoutreader', allow_patterns=layoutreader_pattern)
