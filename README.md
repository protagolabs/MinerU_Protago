...
## Devlog
05/15/2025 : we update the TED and TED structure calculation based on the official code in [PubTabNet](https://github.com/ibm-aur-nlp/PubTabNet). Further evaluations will be conducted on this.

| Sample Size  | Tools (version)  |    TED     | TED structure |
|------------- |------------------|------------|---------------|
| ~176 (v1)    |  MinerU (1.3.3)  |    64.51%  |    81.06%     |
| ~174 (v1)    |  Marker (1.3.3)  |    55.49%  |    65.786%    |

1. TED: table content, TED Structure: table structure
2. PubTabNet: research paper score scheme, table in html format comparison
3. Marker miss 2 pdfs, total tables: ~14000, missing around ~600
4. More comparison: https://github.com/dantetemplar/pdf-extraction-agenda
